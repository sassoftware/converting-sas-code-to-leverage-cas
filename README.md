...
**CASL.MPConnect.sas**
- Compute Server and CAS enabled.
...
**SASEnterpriseSessionMonitorScheduledJobPostgres2CAS**
- SPRE
...
**sasLogParserBatchServer.sas**
- Compute Server (SPRE)
- SAS 9 workspace server
- Parses logs generated by the SAS Batch Server.
- This code includes sasLogParserMacrosBatchServer.sas and then parses SAS logs to identify which steps are canidates to be - optimized by running - that code in CAS.

**sasLogParserMacrosBatchServer.sas**
- Compute Server (SPRE)
- SAS 9 workspace server
- Parses logs generated by the SAS Batch Server.
- Included by the program sasLogParserBatchServer.sas.
- Note, when saving this file to disk ensure you name it sasLogParserMacrosBatchServer.sas.

**sasLogParserStoredProcessServer.sas**
- Compute Server (SPRE)
- SAS 9 workspace server
- Parses logs generated by the SAS Stored Process Server.
- This code includes sasLogParserMacrosStoredProcessServer.sas and then parses SAS logs to identify which steps are canidates - to be optimized by running that code in CAS.

**sasLogParserMacrosStoredProcessServer.sas**
- Compute Server (SPRE)
- SAS 9 workspace server
- Parses logs generated by the SAS Store Process Server.
- Included by the program sasLogParseStoredProcessServer.sas.
- Note, when saving this file to disk ensure you name it sasLogParserMacrosStoredProcessServer.sas.

**sasLogParserWorkspaceServer.sas**
- Compute Server (SPRE)
- SAS 9 workspace server
- Parses logs generated by the SAS Workspace Server.
- This code includes sasLogParserMacrosWorkspaceServer.sas and then parses SAS logs to identify which steps are canidates to - be optimized by running that code in CAS.

**sasLogParserMacrosWorkspaceServer.sas**
- Compute Server (SPRE)
- SAS 9 workspace server
- Parses logs generated by the SAS Workspace Server.
- Included by the program sasLogParserWorkspaceServer.sas.
- Note, when saving this file to disk ensure you name it sasLogParserMacrosWorkspaceServer.sas.
